...
export const CallToAction =()=>{
    ...
    >
        <div className="container">
            ...
            <motion.img src="/assets/images/cuboid.png" alt="" className="size-[140px]"style={{
                rotate:rotate,
            }} />
            </Circle>
                </div>
            ...
            <motion.img src="/assets/images/cylinder.png" alt="" className="size-[140px]" style={{
                rotate,
            }}/>
            </Circle>
                </div>
...
<div className="flex justify-center mt-12 "><CutCornerButton>Get Started</CutCornerButton></div>
</div>
        </div>
    </section>
}