      ...
      <footer className="py-24 bg-zinc-950">
        <div className="container">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex teaxt-zinc-500 font-heading font-black gap-12">
          ...
          <div className="mt-12 md:mt-48 md:flex justify-between items-center">
            ...
            <div className="mt-4 md:mt-0 flex gap-6">
              {socialIcons.map((icon, iconIndex) => (
                <div
                  key={iconIndex}
                  className="inline-flex w-10 h-10 bg-zinc-800 rounded-full items-center justify-center"
                >
                  {icon.icon}
                </div>
              ))}
