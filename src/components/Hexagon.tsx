...
//     const [totalPtahLength,  setTotalPathLength] =useState<number>();
//         useLayoutEffect(()=>{
...
//             }}
//             animate={{
//                 strokeDashoffset: reverse ? totalPtahLength : totalPtahLength*-1
//             }}
//             transition={{
//             repeat:Infinity,
//             duration,
...
//             }}
//             style={{
//                 strokeDasharray:`500 ${totalPtahLength -500}`,
//                 height:size,
//                 width:size,
//             }}
//             >
...
export const Hexagon = (props: ComponentPropsWithoutRef<'svg'> & { size?: number; reverse?: boolean; duration?: number }) => {
  const { className, size = 800, reverse = false, duration = 30 } = props;
  const pathRef = useRef<SVGPathElement>(null);
  const [totalPathLength, setTotalPathLength] = useState<number | undefined>();
    ...
    <div className="inline-flex relative">
      ...
      {totalPathLength && (
        <motion.svg
          ...
          animate={{
            strokeDashoffset: reverse ? totalPathLength : -totalPathLength,
          }}
          transition={{
            repeat: Infinity,
            duration,
